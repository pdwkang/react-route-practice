	...
	render: function(){
		...
		return(
			<div>
				...
				<p>It is currently {this.state.temp} degreeeeeeees</p>
				<p>Max: {this.state.temp_max}</p>
				<p>Min: {this.state.temp_min}</p>
				<img src={iconSrc}/>{this.state.desc}
			</div>
		);
	}
});
...
function Images(props){
	...
	return(
		<div>
			{props.route.images.map(function(imageSrc, index){
		  ...
		  <div className="container-fluid">
		    ...
		    <ul className="nav navbar-nav">
		    	<li><ReactRouter.Link to="/">Home</ReactRouter.Link></li>
		      	...
		      	<li><ReactRouter.Link to="/image">Images</ReactRouter.Link></li>
		      	<li><ReactRouter.Link to="/weather">Weather</ReactRouter.Link></li>
		      	<li><ReactRouter.Link to="/mayor-message">Mayor Message</ReactRouter.Link></li>
		    </ul>
		  </div>
		</nav>    
	)
...
console.log(ReactRouter.Route.props)
...
ReactDOM.render(
	<ReactRouter.Router>
		<ReactRouter.Route path="/" component={App}>
			...
			<ReactRouter.Route path="image" component={Images} images={atlImages}/>
			<ReactRouter.Route path="weather" component={Atlanta} />
			<ReactRouter.Route path="mayor-message" component={MayorMessage} />
		</ReactRouter.Route>
	</ReactRouter.Router>,
